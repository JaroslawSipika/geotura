...
//             let ilosctrasbieszczady;
//             ilosctrastatry = data[0];
//             ilosctraspieniny = data[1];
//             ilosctrasbeskidslaski = data[2];
//             ilosctrasbeskidmaly = data[3];
//             ilosctrasbeskidzywiecki = data[4];
//             ilosctrasgorce = data[5];
//             ilosctrasbeskidsadecki = data[6];
//             ilosctrasbeskidniski = data[7];
//             ilosctrasbieszczady = data[8];
//
//             let ilosctrastatryz;
//             let ilosctraspieninyz;
//             let ilosctrasbeskidslaskiz;
...
//             let ilosctrasbeskidniskiz;
//             let ilosctrasbieszczadyz;
//             ilosctrastatryz = data[9];
//             ilosctraspieninyz = data[10];
//             ilosctrasbeskidslaskiz = data[11];
//             ilosctrasbeskidmalyz = data[12];
//             ilosctrasbeskidzywieckiz = data[13];
//             ilosctrasgorcez = data[14];
//             ilosctrasbeskidsadeckiz = data[15];
//             ilosctrasbeskidniskiz = data[16];
//             ilosctrasbieszczadyz = data[17];
//
//             let ilosctrastatryu;
//             let ilosctraspieninyu;
//             let ilosctrasbeskidslaskiu;
...
//             let ilosctrasbeskidniskiu;
//             let ilosctrasbieszczadyu;
//             ilosctrastatryu = data[18];
//             ilosctraspieninyu = data[19];
//             ilosctrasbeskidslaskiu = data[20];
//             ilosctrasbeskidmalyu = data[21];
//             ilosctrasbeskidzywieckiu = data[22];
//             ilosctrasgorceu = data[23];
//             ilosctrasbeskidsadeckiu = data[24];
//             ilosctrasbeskidniskiu = data[25];
//             ilosctrasbieszczadyu = data[26];
//
//             let ilosctrastatryd;
//             let ilosctraspieninyd;
//             let ilosctrasbeskidslaskid;
...
//             let ilosctrasbeskidniskid;
//             let ilosctrasbieszczadyd;
//             ilosctrastatryd = data[27];
//             ilosctraspieninyd = data[28];
//             ilosctrasbeskidslaskid = data[29];
//             ilosctrasbeskidmalyd = data[30];
//             ilosctrasbeskidzywieckid = data[31];
//             ilosctrasgorced = data[32];
//             ilosctrasbeskidsadeckid = data[33];
//             ilosctrasbeskidniskid = data[34];
//             ilosctrasbieszczadyd = data[35];
//
//             let ilosctrastatryc;
//             let ilosctraspieninyc;
//             let ilosctrasbeskidslaskic;
...
//             let ilosctrasbeskidniskic;
//             let ilosctrasbieszczadyc;
//             ilosctrastatryc = data[36];
//             ilosctraspieninyc = data[37];
//             ilosctrasbeskidslaskic = data[38];
//             ilosctrasbeskidmalyc = data[39];
//             ilosctrasbeskidzywieckic = data[40];
//             ilosctrasgorcec = data[41];
//             ilosctrasbeskidsadeckic = data[42];
//             ilosctrasbeskidniskic = data[43];
//             ilosctrasbieszczadyc = data[44];
//
//             document.getElementById("ilosctrastatry").innerHTML = ilosctrastatry;
//             document.getElementById("ilosctraspieniny").innerHTML = ilosctraspieniny;
//             document.getElementById("ilosctrasbeskidslaski").innerHTML = ilosctrasbeskidslaski ;
